...
async function main() {
  ...
  const migrationPath = path.join(rootDir, 'prisma', 'migration_v2_farmapos.sql');

  console.log('--- STARTING SAFE INCREMENTAL MIGRATION APPLICATION ---');
  await runSqlFile(migrationPath);
  console.log('--- SAFE INCREMENTAL MIGRATION COMPLETED ---');
}
