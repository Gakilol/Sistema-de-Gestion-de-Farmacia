-- =========================================================================
--  SCRIPT DE BASE DE DATOS MAESTRO Y DE INTEGRACIÓN CONTINUA
--  SISTEMA DE GESTIÓN DE FARMACIA - PODOCARE SYSTEM (UNIVERSIDAD NACIONAL DE INGENIERÍA)
--  
--  Incluye: 
--    0. Infraestructura de Almacenamiento (Tablespaces de datos/índices)
--    1. Limpieza de base de datos (Instalación limpia)
--    2. Estructura relacional completa (Core Tables)
--    3. Estructura de auditoría y estadísticas reactivas
--    4. Triggers procedimentales y automatizaciones de stock/precios
--    5. Procedimientos almacenados administrativos (Reportes, cierres, Kardex)
--    6. Semilla de datos reales adaptados al contexto de Nicaragua
-- =========================================================================

-- ─────────────────────────────────────────────────────────────────────────
-- 0. INFRAESTRUCTURA DE ALMACENAMIENTO (TABLESPACES)
-- ─────────────────────────────────────────────────────────────────────────
-- NOTA: La creación de Tablespaces requiere privilegios de superusuario. 
-- Descomentar estas líneas si se ejecuta localmente en PostgreSQL y se ha 
-- creado la carpeta física 'C:\farmacia\data' en el disco.
-- Si se implementa en servidores la nube (como NeonDB), dejar comentadas ya que 
-- el almacenamiento se gestiona de manera automática (serverless).

-- CREATE TABLESPACE farmacia_data LOCATION 'C:\farmacia\data';
-- ALTER DATABASE db_farmacia SET TABLESPACE farmacia_data;
...
CREATE TABLE "Venta" (
    "id" SERIAL PRIMARY KEY,
    "fecha" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "idCliente" INTEGER REFERENCES "Cliente"("id") ON DELETE SET NULL ON UPDATE CASCADE,
    "total" DECIMAL(10,2) NOT NULL,
...
CREATE INDEX "PasswordResetToken_correo_idx" ON "PasswordResetToken"("correo");
...
-- TRIGGER 2: ESTADÍSTICAS GLOBALES DE VENTA POR PRODUCTO
...
-- TRIGGER 3: ALERTA AUTOMÁTICA DE STOCK BAJO
...
-- TRIGGER 4: RASTREO Y AUDITORÍA DE HISTORIAL DE PRECIOS
...
-- IDENTIFICACIÓN RÁPIDA DE STOCK BAJO
...
-- ===== SEMILLA DE PROVEEDORES DE NICARAGUA =====
...
-- ===== SEMILLA DE PRODUCTOS POPULARES (PRECIOS EN C$) =====
...
(1, 'Panadol Ultra 500mg (Caja 24)', '7401004123456', 'Panadol Ultra con cafeína para alivio rápido de dolores de cabeza fuertes.', 1, 40.00, 60.00, 148, 20, true),
(2, 'Tafirol 500mg Paracetamol (Caja 100)', '7501004123457', 'Paracetamol de 500mg para control de fiebre y dolor general.', 1, 120.00, 180.00, 79, 15, true),
(3, 'Apronax 550mg Naproxeno (Caja 10)', '7801004123458', 'Naproxeno Sódico de 550mg potente antiinflamatorio y analgésico.', 1, 85.00, 125.00, 119, 25, true),
(4, 'Neurobión Inyectable Triple Dosis (3ml)', '7901004123459', 'Complejo B inyectable para neuritis y dolores musculares severos.', 1, 150.00, 220.00, 58, 10, true),
...
(6, 'Crema Quadriderm Dérmica (20g)', '7401004123461', 'Crema tópica antiinflamatoria, bactericida y antimicótica de amplio espectro.', 2, 180.00, 250.00, 44, 10, true),
...
(8, 'Clotrimazol Crema Antimicótica 1% (20g)', '7401004123463', 'Tratamiento fungicida de pie de atleta e infecciones dérmicas.', 2, 45.00, 75.00, 69, 12, true),
...
(10, 'Loratadina 10mg Antialérgico (Caja 10)', '7401004123465', 'Antihistamínico de segunda generación para alivio de alergias sin sueño.', 1, 20.00, 35.00, 107, 20, true),
...
(1, 1, 'LT-PAN-0526', '2028-05-30 00:00:00', 150, 148, 40.00, true),
(2, 2, 'LT-TAF-0326', '2028-03-15 00:00:00', 80, 79, 120.00, true),
(3, 3, 'LT-APR-1125', '2027-11-20 00:00:00', 120, 119, 85.00, true),
(4, 4, 'LT-NEU-0726', '2028-07-10 00:00:00', 60, 58, 150.00, true),
(5, 5, 'LT-ALK-0826', '2028-08-05 00:00:00', 200, 200, 30.00, true),
(6, 6, 'LT-QUA-0126', '2028-01-20 00:00:00', 45, 44, 180.00, true),
(7, 7, 'LT-ELE-1225', '2027-12-01 00:00:00', 90, 90, 28.00, true),
(8, 8, 'LT-CLO-0426', '2028-04-18 00:00:00', 70, 69, 45.00, true),
(9, 9, 'LT-AMO-0926', '2028-09-25 00:00:00', 55, 55, 90.00, true),
(10, 10, 'LT-LOR-0226', '2028-02-14 00:00:00', 110, 107, 20.00, true),
...
INSERT INTO "DetalleCompra" ("id", "idCompra", "idProducto", "cantidad", "precioUnitario", "subtotal", "lote", "fechaVencimiento") VALUES
(1, 1, 1, 150, 40.00, 6000.00, 'LT-PAN-0526', '2028-05-30 00:00:00');

-- ===== SEMILLA DE HISTORIAL DE VENTAS =====
INSERT INTO "Venta" ("id", "fecha", "idCliente", "total", "metodoPago", "idUsuario", "nombrePodologo", "numeroReceta") VALUES
(1, CURRENT_DATE - INTERVAL '5 days' + TIME '10:30:00', 1, 180.00, 'EFECTIVO', 2, 'Dra. Ana López', 'REC-2026-0091'),
(2, CURRENT_DATE - INTERVAL '4 days' + TIME '14:15:00', 2, 120.00, 'TARJETA', 2, NULL, NULL),
(3, CURRENT_DATE - INTERVAL '3 days' + TIME '11:00:00', 3, 440.00, 'EFECTIVO', 2, 'Dr. José Ramírez', 'REC-2026-0103'),
(4, CURRENT_DATE - INTERVAL '2 days' + TIME '16:45:00', 4, 305.00, 'TRANSFERENCIA', 2, 'Dr. José Ramírez', 'REC-2026-0104'),
(5, CURRENT_DATE - INTERVAL '1 days' + TIME '09:20:00', 1, 250.00, 'EFECTIVO', 2, 'Dra. Ana López', 'REC-2026-0112');

INSERT INTO "DetalleVenta" ("id", "idVenta", "idProducto", "cantidad", "precioUnitario", "subtotal", "tipoUnidad") VALUES
(1, 1, 2, 1, 180.00, 180.00, 'UNIDAD'),
(2, 2, 1, 2, 60.00, 120.00, 'UNIDAD'),
(3, 3, 4, 2, 220.00, 440.00, 'UNIDAD'),
(4, 4, 3, 1, 125.00, 125.00, 'UNIDAD'),
(5, 4, 8, 1, 75.00, 75.00, 'UNIDAD'),
(6, 4, 10, 3, 35.00, 105.00, 'UNIDAD'),
(7, 5, 6, 1, 250.00, 250.00, 'UNIDAD');

-- ===== MOVIMIENTOS KARDEX DE SALIDA DE VENTAS =====
INSERT INTO "MovimientoInventario" ("idProducto", "idLote", "tipo", "cantidad", "stockResultante", "costoUnitario", "referencia", "idUsuario") VALUES
...
-- ===== COMPLETADO =====
RAISE NOTICE '🎉 Base de datos del Sistema de Farmacia inicializada con éxito para NeonDB o pgAdmin4!';
