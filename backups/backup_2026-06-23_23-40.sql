...
\restrict JDyEuqOz2cVLNEF4J4BSByZ4bx0ZZWr2hGajxu1awCWGV9Ivejh3EvpOsEAo9Qe
...
ALTER TABLE ONLY public."ProductoVentaStats" DROP CONSTRAINT "ProductoVentaStats_idProducto_fkey";
...
ALTER TABLE ONLY public."HistorialPrecios" DROP CONSTRAINT "HistorialPrecios_idProducto_fkey";
...
ALTER TABLE ONLY public."ClienteProductoStats" DROP CONSTRAINT "ClienteProductoStats_idProducto_fkey";
ALTER TABLE ONLY public."ClienteProductoStats" DROP CONSTRAINT "ClienteProductoStats_idCliente_fkey";
...
ALTER TABLE ONLY public."AlertaStockBajo" DROP CONSTRAINT "AlertaStockBajo_idProducto_fkey";
...
DROP TRIGGER tr_alerta_stock_bajo ON public."Producto";
...
ALTER TABLE ONLY public."ProductoVentaStats" DROP CONSTRAINT "ProductoVentaStats_pkey";
ALTER TABLE ONLY public."ProductoVentaStats" DROP CONSTRAINT "ProductoVentaStats_idProducto_key";
...
ALTER TABLE ONLY public."HistorialPrecios" DROP CONSTRAINT "HistorialPrecios_pkey";
...
ALTER TABLE ONLY public."ClienteProductoStats" DROP CONSTRAINT "ClienteProductoStats_pkey";
ALTER TABLE ONLY public."ClienteProductoStats" DROP CONSTRAINT "ClienteProductoStats_idCliente_idProducto_key";
...
ALTER TABLE ONLY public."AlertaStockBajo" DROP CONSTRAINT "AlertaStockBajo_pkey";
...
ALTER TABLE public."ProductoVentaStats" ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE public."HistorialPrecios" ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE public."ClienteProductoStats" ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE public."AlertaStockBajo" ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE public."ProductoVentaStats_id_seq";
DROP TABLE public."ProductoVentaStats";
...
DROP SEQUENCE public."HistorialPrecios_id_seq";
DROP TABLE public."HistorialPrecios";
...
DROP SEQUENCE public."ClienteProductoStats_id_seq";
DROP TABLE public."ClienteProductoStats";
...
DROP SEQUENCE public."AlertaStockBajo_id_seq";
DROP TABLE public."AlertaStockBajo";
...
DROP FUNCTION public.fn_alerta_stock_bajo();
...
--
-- Name: fn_alerta_stock_bajo(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_alerta_stock_bajo() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: AlertaStockBajo; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."AlertaStockBajo" (
    id integer NOT NULL,
    "idProducto" integer NOT NULL,
    "nombreProducto" character varying(255) NOT NULL,
    "stockActual" integer NOT NULL,
    "stockMinimo" integer NOT NULL,
    "fechaAlerta" timestamp without time zone DEFAULT now(),
    resuelta boolean DEFAULT false
);


--
-- Name: AlertaStockBajo_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."AlertaStockBajo_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: AlertaStockBajo_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."AlertaStockBajo_id_seq" OWNED BY public."AlertaStockBajo".id;
...
--
-- Name: ClienteProductoStats; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."ClienteProductoStats" (
    id integer NOT NULL,
    "idCliente" integer NOT NULL,
    "idProducto" integer NOT NULL,
    "totalComprado" integer DEFAULT 0 NOT NULL,
    "vecesComprado" integer DEFAULT 0 NOT NULL,
    "ultimaCompra" timestamp without time zone DEFAULT now()
);


--
-- Name: ClienteProductoStats_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."ClienteProductoStats_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ClienteProductoStats_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."ClienteProductoStats_id_seq" OWNED BY public."ClienteProductoStats".id;
...
--
-- Name: HistorialPrecios; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."HistorialPrecios" (
    id integer NOT NULL,
    "idProducto" integer NOT NULL,
    "nombreProducto" character varying(255) NOT NULL,
    "precioVentaAnterior" numeric(10,2),
    "precioVentaNuevo" numeric(10,2),
    "precioCompraAnterior" numeric(10,2),
    "precioCompraNuevo" numeric(10,2),
    "fechaCambio" timestamp without time zone DEFAULT now()
);


--
-- Name: HistorialPrecios_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."HistorialPrecios_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: HistorialPrecios_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."HistorialPrecios_id_seq" OWNED BY public."HistorialPrecios".id;
...
--
-- Name: ProductoVentaStats; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."ProductoVentaStats" (
    id integer NOT NULL,
    "idProducto" integer NOT NULL,
    "totalUnidadesVendidas" integer DEFAULT 0 NOT NULL,
    "totalVecesVendido" integer DEFAULT 0 NOT NULL,
    "ingresoTotal" numeric(12,2) DEFAULT 0 NOT NULL,
    "ultimaVenta" timestamp without time zone DEFAULT now()
);


--
-- Name: ProductoVentaStats_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."ProductoVentaStats_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ProductoVentaStats_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."ProductoVentaStats_id_seq" OWNED BY public."ProductoVentaStats".id;
...
--
-- Name: AlertaStockBajo id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."AlertaStockBajo" ALTER COLUMN id SET DEFAULT nextval('public."AlertaStockBajo_id_seq"'::regclass);
...
--
-- Name: ClienteProductoStats id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ClienteProductoStats" ALTER COLUMN id SET DEFAULT nextval('public."ClienteProductoStats_id_seq"'::regclass);
...
--
-- Name: HistorialPrecios id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."HistorialPrecios" ALTER COLUMN id SET DEFAULT nextval('public."HistorialPrecios_id_seq"'::regclass);
...
--
-- Name: ProductoVentaStats id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProductoVentaStats" ALTER COLUMN id SET DEFAULT nextval('public."ProductoVentaStats_id_seq"'::regclass);
...
--
-- Data for Name: AlertaStockBajo; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."AlertaStockBajo" (id, "idProducto", "nombreProducto", "stockActual", "stockMinimo", "fechaAlerta", resuelta) FROM stdin;
\.
...
COPY public."AtencionPodologica" (id, "idCita", "idCliente", "idUsuario", fecha, subjetivo, objetivo, analisis, plan, "esDatoPrueba", "createdAt", "updatedAt") FROM stdin;
2	4	49	9	2026-06-24 05:18:32.56	Presenta una comezon anormal en la planta de los pies	Examen de hongos	Hongo detectado por sudoracion	Clotrimazol al 1% durante 14 dias, cita para control	f	2026-06-24 05:18:32.56	2026-06-24 05:18:32.56
\.
...
COPY public."AuditoriaLog" (id, accion, entidad, "entidadId", detalles, "idUsuario", "createdAt") FROM stdin;
7	LOGIN_EXITOSO	Usuario	9	{"correo":"kevingabrield23@gmail.com","rol":"ADMIN"}	9	2026-06-23 18:26:29.084
8	IA_CHAT_CONSULTA	AsistenteIA	\N	{"rol":"ADMIN","mensajes":2}	9	2026-06-23 18:27:49.472
9	IA_GEMINI_ERROR	AsistenteIA	\N	{"status":503}	9	2026-06-23 18:27:49.927
10	IA_CHAT_CONSULTA	AsistenteIA	\N	{"rol":"ADMIN","mensajes":4}	9	2026-06-23 18:27:59.982
11	IA_TOOL_GET_DASHBOARD_SUMMARY	AsistenteIA	\N	{"herramienta":"getDashboardSummary","rol":"ADMIN","resultado":"OK","fuente":"Inventario, Lotes y Ventas en tiempo real."}	9	2026-06-23 18:28:00.939
12	LOGIN_EXITOSO	Usuario	9	{"correo":"kevingabrield23@gmail.com","rol":"ADMIN"}	9	2026-06-24 04:09:40.985
13	CREAR_PRODUCTO	Producto	98	{"nombre":"er","precioVenta":"6","stockActual":10}	9	2026-06-24 04:21:10.577
14	CREAR_COMPRA	Compra	17	{"total":111,"idProveedor":16,"numeroFactura":"FAC","items":1,"productos":[{"idProducto":98,"cantidad":111,"precioUnitario":1,"lote":"231-RE-2"}]}	9	2026-06-24 04:22:49.726
15	CREAR_COMPRA	Compra	18	{"total":100,"idProveedor":16,"numeroFactura":"001","items":1,"productos":[{"idProducto":98,"cantidad":100,"precioUnitario":1,"lote":"55454"}]}	9	2026-06-24 04:42:03.701
16	CREAR_DEVOLUCION	DevolucionProveedor	1	{"idProducto":98,"lote":"55454","cantidad":100,"proveedorId":16,"motivo":"PRÓXIMO_A_VENCER"}	9	2026-06-24 04:48:22.336
17	CREAR_VENTA	Venta	46	{"total":42,"metodoPago":"TRANSFERENCIA","idCliente":50,"tipoComprobante":"RECIBO","estado":"COMPLETADA","montoRecibido":null,"cambio":null,"rucCliente":null,"items":1,"productos":[{"idProducto":98,"cantidad":7,"tipoUnidad":"UNIDAD"}],"lotesDeducidos":[{"idProducto":98,"lote":"231-F","cantidad":7}]}	9	2026-06-24 04:52:01.816
18	IA_CHAT_CONSULTA	AsistenteIA	\N	{"rol":"ADMIN","mensajes":2}	9	2026-06-24 05:05:31.32
19	IA_TOOL_GET_NEAR_EXPIRATION	AsistenteIA	\N	{"herramienta":"getProductsNearExpiration","rol":"ADMIN","resultado":"OK","fuente":"Lotes próximos a vencer en los próximos 90 días (hasta el 22/9/2026)."}	9	2026-06-24 05:05:32.534
20	IA_CHAT_CONSULTA	AsistenteIA	\N	{"rol":"ADMIN","mensajes":4}	9	2026-06-24 05:05:47.291
21	IA_TOOL_GET_TOP_SELLING	AsistenteIA	\N	{"herramienta":"getTopSellingProducts","rol":"ADMIN","resultado":"OK","fuente":"Ventas del 25/5/2026 al 24/6/2026."}	9	2026-06-24 05:05:48.354
22	IA_CHAT_CONSULTA	AsistenteIA	\N	{"rol":"ADMIN","mensajes":6}	9	2026-06-24 05:06:34.827
23	IA_TOOL_GET_DASHBOARD_SUMMARY	AsistenteIA	\N	{"herramienta":"getDashboardSummary","rol":"ADMIN","resultado":"OK","fuente":"Inventario, Lotes y Ventas en tiempo real."}	9	2026-06-24 05:06:35.934
24	IA_CHAT_CONSULTA	AsistenteIA	\N	{"rol":"ADMIN","mensajes":8}	9	2026-06-24 05:06:51.58
25	IA_CHAT_CONSULTA	AsistenteIA	\N	{"rol":"ADMIN","mensajes":10}	9	2026-06-24 05:08:30.485
26	IA_CHAT_CONSULTA	AsistenteIA	\N	{"rol":"ADMIN","mensajes":12}	9	2026-06-24 05:09:01.534
27	IA_TOOL_SEARCH_PRODUCTS	AsistenteIA	\N	{"herramienta":"searchProducts","rol":"ADMIN","resultado":"OK","fuente":"Búsqueda en catálogo de productos activos. Término: \\"er\\"."}	9	2026-06-24 05:09:02.717
28	IA_TOOL_GET_PRODUCT_DETAILS	AsistenteIA	\N	{"herramienta":"getProductDetails","rol":"ADMIN","resultado":"OK","fuente":"Datos del producto ID 98 con sus lotes activos (FEFO)."}	9	2026-06-24 05:09:03.742
\.
...
COPY public."CategoriaProducto" (id, nombre, descripcion, "createdAt", "updatedAt", "esDatoPrueba") FROM stdin;
16	A		2026-06-24 04:20:17.283	2026-06-24 04:20:17.283	f
17	Analgesico 		2026-06-24 04:20:51.355	2026-06-24 04:20:51.355	f
\.
...
COPY public."Cliente" (id, "nombreCompleto", telefono, correo, cedula, ruc, direccion, activo, "createdAt", "updatedAt", "esDatoPrueba") FROM stdin;
49	Justin Ramsess Flores Camacho	57921648	tututu@gmail.com	001-150898-1021R	\N	ceibo 1/2 c abajo	t	2026-06-24 04:13:27.849	2026-06-24 04:13:27.849	f
48	justin Ramses Flores Camacho	57921649	tututtu@gmail.com	001-188181-5150R	\N	ceibo 1/2 c abajo	t	2026-06-24 04:11:13.751	2026-06-24 04:13:58.75	f
50	Kevin	11111111	ererer@hotmail.com	001-180685-1587Z	\N	mercado Oriental	t	2026-06-24 04:15:28.13	2026-06-24 04:15:28.13	f
\.


--
-- Data for Name: ClienteProductoStats; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."ClienteProductoStats" (id, "idCliente", "idProducto", "totalComprado", "vecesComprado", "ultimaCompra") FROM stdin;
69	50	98	7	1	2026-06-24 04:52:01.659605
\.
...
COPY public."DetalleVenta" (id, "idVenta", "idProducto", cantidad, "precioUnitario", subtotal, "tipoUnidad", "createdAt", "updatedAt") FROM stdin;
93	46	98	7	6.00	42.00	UNIDAD	2026-06-24 04:52:01.678	2026-06-24 04:52:01.678
\.
...
--
-- Data for Name: HistorialPrecios; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."HistorialPrecios" (id, "idProducto", "nombreProducto", "precioVentaAnterior", "precioVentaNuevo", "precioCompraAnterior", "precioCompraNuevo", "fechaCambio") FROM stdin;
\.
...
COPY public."Producto" (id, nombre, "codigoBarras", descripcion, "fechaVencimiento", "idCategoria", "precioCompra", "precioVenta", "precioBlister", "precioCaja", "unidadesPorBlister", "unidadesPorCaja", "stockActual", "stockMinimo", activo, "createdAt", "updatedAt", concentracion, "esDatoPrueba", "esServicio", laboratorio, "unidadMedida") FROM stdin;
98	er	88549645641894	a	\N	17	1.00	6.00	2.40	384.00	2	320	114	1	t	2026-06-24 04:21:10.516	2026-06-24 04:52:01.806	1000000 mg	f	f	prrrr	nada 
\.


--
-- Data for Name: ProductoVentaStats; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."ProductoVentaStats" (id, "idProducto", "totalUnidadesVendidas", "totalVecesVendido", "ingresoTotal", "ultimaVenta") FROM stdin;
86	98	7	1	42.00	2026-06-24 04:52:01.659605
\.
...
COPY public."Proveedor" (id, nombre, telefono, correo, direccion, "createdAt", "updatedAt", "esDatoPrueba") FROM stdin;
16	si	7878785	r@gmail.com	1	2026-06-24 04:21:47.236	2026-06-24 04:21:47.236	f
\.
...
COPY public."Venta" (id, fecha, "idCliente", total, "metodoPago", "nombrePodologo", "numeroReceta", "idUsuario", "tipoComprobante", estado, "montoRecibido", cambio, "rucCliente", "createdAt", "updatedAt") FROM stdin;
46	2026-06-24 04:52:01.676	50	42.00	TRANSFERENCIA	\N	\N	9	RECIBO	COMPLETADA	\N	\N	\N	2026-06-24 04:52:01.678	2026-06-24 04:52:01.678
\.


--
-- Name: AlertaStockBajo_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."AlertaStockBajo_id_seq"', 10, true);
...
SELECT pg_catalog.setval('public."AuditoriaLog_id_seq"', 28, true);
...
SELECT pg_catalog.setval('public."Auditoria_id_seq"', 29175, true);
...
SELECT pg_catalog.setval('public."CategoriaProducto_id_seq"', 17, true);
...
--
-- Name: ClienteProductoStats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."ClienteProductoStats_id_seq"', 69, true);
...
SELECT pg_catalog.setval('public."DetalleCompra_id_seq"', 88, true);
...
SELECT pg_catalog.setval('public."DetalleVenta_id_seq"', 93, true);
...
--
-- Name: HistorialPrecios_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."HistorialPrecios_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."Lote_id_seq"', 100, true);
...
SELECT pg_catalog.setval('public."MovimientoInventario_id_seq"', 194, true);
...
--
-- Name: ProductoVentaStats_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."ProductoVentaStats_id_seq"', 86, true);
...
SELECT pg_catalog.setval('public."Producto_id_seq"', 98, true);
...
SELECT pg_catalog.setval('public."Venta_id_seq"', 46, true);
...
--
-- Name: AlertaStockBajo AlertaStockBajo_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."AlertaStockBajo"
    ADD CONSTRAINT "AlertaStockBajo_pkey" PRIMARY KEY (id);
...
--
-- Name: ClienteProductoStats ClienteProductoStats_idCliente_idProducto_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ClienteProductoStats"
    ADD CONSTRAINT "ClienteProductoStats_idCliente_idProducto_key" UNIQUE ("idCliente", "idProducto");


--
-- Name: ClienteProductoStats ClienteProductoStats_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ClienteProductoStats"
    ADD CONSTRAINT "ClienteProductoStats_pkey" PRIMARY KEY (id);
...
--
-- Name: HistorialPrecios HistorialPrecios_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."HistorialPrecios"
    ADD CONSTRAINT "HistorialPrecios_pkey" PRIMARY KEY (id);
...
--
-- Name: ProductoVentaStats ProductoVentaStats_idProducto_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProductoVentaStats"
    ADD CONSTRAINT "ProductoVentaStats_idProducto_key" UNIQUE ("idProducto");


--
-- Name: ProductoVentaStats ProductoVentaStats_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProductoVentaStats"
    ADD CONSTRAINT "ProductoVentaStats_pkey" PRIMARY KEY (id);
...
--
-- Name: Producto tr_alerta_stock_bajo; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER tr_alerta_stock_bajo AFTER UPDATE OF "stockActual" ON public."Producto" FOR EACH ROW EXECUTE FUNCTION public.fn_alerta_stock_bajo();
...
--
-- Name: AlertaStockBajo AlertaStockBajo_idProducto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."AlertaStockBajo"
    ADD CONSTRAINT "AlertaStockBajo_idProducto_fkey" FOREIGN KEY ("idProducto") REFERENCES public."Producto"(id) ON DELETE CASCADE;
...
--
-- Name: ClienteProductoStats ClienteProductoStats_idCliente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ClienteProductoStats"
    ADD CONSTRAINT "ClienteProductoStats_idCliente_fkey" FOREIGN KEY ("idCliente") REFERENCES public."Cliente"(id) ON DELETE CASCADE;


--
-- Name: ClienteProductoStats ClienteProductoStats_idProducto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ClienteProductoStats"
    ADD CONSTRAINT "ClienteProductoStats_idProducto_fkey" FOREIGN KEY ("idProducto") REFERENCES public."Producto"(id) ON DELETE CASCADE;
...
--
-- Name: HistorialPrecios HistorialPrecios_idProducto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."HistorialPrecios"
    ADD CONSTRAINT "HistorialPrecios_idProducto_fkey" FOREIGN KEY ("idProducto") REFERENCES public."Producto"(id) ON DELETE CASCADE;
...
--
-- Name: ProductoVentaStats ProductoVentaStats_idProducto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ProductoVentaStats"
    ADD CONSTRAINT "ProductoVentaStats_idProducto_fkey" FOREIGN KEY ("idProducto") REFERENCES public."Producto"(id) ON DELETE CASCADE;
...
\unrestrict JDyEuqOz2cVLNEF4J4BSByZ4bx0ZZWr2hGajxu1awCWGV9Ivejh3EvpOsEAo9Qe
