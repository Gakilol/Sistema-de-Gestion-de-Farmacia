...
\restrict HriNvApNlnZZXksSJcMAfeiHXIrhd9h6ShsCaxQ0fTu59MANWUlL1NoHYzEh4Af
...
ALTER TABLE ONLY public."ExamenPaciente" DROP CONSTRAINT "ExamenPaciente_registradoPor_fkey";
ALTER TABLE ONLY public."ExamenPaciente" DROP CONSTRAINT "ExamenPaciente_idPaciente_fkey";
...
DROP INDEX public."ExamenPaciente_tipo_idx";
DROP INDEX public."ExamenPaciente_idPaciente_idx";
DROP INDEX public."ExamenPaciente_fechaExamen_idx";
...
ALTER TABLE ONLY public."ExamenPaciente" DROP CONSTRAINT "ExamenPaciente_pkey";
...
ALTER TABLE public."ExamenPaciente" ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE public."ExamenPaciente_id_seq";
DROP TABLE public."ExamenPaciente";
...
--
-- Name: ExamenPaciente; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."ExamenPaciente" (
    id integer NOT NULL,
    "idPaciente" integer NOT NULL,
    nombre text NOT NULL,
    tipo text NOT NULL,
    "fechaExamen" timestamp(3) without time zone NOT NULL,
    resultado text,
    interpretacion text,
    observaciones text,
    "archivoUrl" text,
...
--
-- Name: ExamenPaciente_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public."ExamenPaciente_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ExamenPaciente_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public."ExamenPaciente_id_seq" OWNED BY public."ExamenPaciente".id;
...
--
-- Name: ExamenPaciente id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ExamenPaciente" ALTER COLUMN id SET DEFAULT nextval('public."ExamenPaciente_id_seq"'::regclass);
...
29202	neondb_owner	2026-06-24	15:46:10.249059	UPDATE	Cliente	127.0.0.1	{"id": 49, "ruc": null, "sexo": null, "activo": true, "cedula": "001-150898-1021R", "correo": "tututu@gmail.com", "telefono": "57921648", "createdAt": "2026-06-24T04:13:27.849", "direccion": "ceibo 1/2 c abajo", "updatedAt": "2026-06-24T04:13:27.849", "tipoPerfil": "FARMACIA", "esDatoPrueba": false, "nombreCompleto": "Justin Ramsess Flores Camacho", "fechaNacimiento": null}	{"id": 49, "ruc": null, "sexo": null, "activo": true, "cedula": "001-150898-1021R", "correo": "tututu@gmail.com", "telefono": "57921648", "createdAt": "2026-06-24T04:13:27.849", "direccion": "ceibo 1/2 c abajo", "updatedAt": "2026-06-24T15:46:10.256", "tipoPerfil": "AMBOS", "esDatoPrueba": false, "nombreCompleto": "Justin Ramsess Flores Camacho", "fechaNacimiento": null}
29203	neondb_owner	2026-06-24	15:47:49.199693	UPDATE	Cliente	127.0.0.1	{"id": 49, "ruc": null, "sexo": null, "activo": true, "cedula": "001-150898-1021R", "correo": "tututu@gmail.com", "telefono": "57921648", "createdAt": "2026-06-24T04:13:27.849", "direccion": "ceibo 1/2 c abajo", "updatedAt": "2026-06-24T15:46:10.256", "tipoPerfil": "AMBOS", "esDatoPrueba": false, "nombreCompleto": "Justin Ramsess Flores Camacho", "fechaNacimiento": null}	{"id": 49, "ruc": null, "sexo": "MASCULINO", "activo": true, "cedula": "001-150898-1021R", "correo": "tututu@gmail.com", "telefono": "57921648", "createdAt": "2026-06-24T04:13:27.849", "direccion": "ceibo 1/2 c abajo", "updatedAt": "2026-06-24T15:47:49.202", "tipoPerfil": "AMBOS", "esDatoPrueba": false, "nombreCompleto": "Justin Ramsess Flores Camacho", "fechaNacimiento": "2006-06-18T00:00:00"}
29204	neondb_owner	2026-06-24	15:48:16.479815	INSERT	Venta	127.0.0.1	\N	{"id": 51, "fecha": "2026-06-24T15:48:16.496", "total": 40.00, "cambio": 460.00, "estado": "COMPLETADA", "createdAt": "2026-06-24T15:48:16.497", "idCliente": null, "idUsuario": 9, "updatedAt": "2026-06-24T15:48:16.497", "metodoPago": "EFECTIVO", "rucCliente": null, "idDescuento": null, "numeroReceta": null, "montoRecibido": 500.00, "descuentoTotal": 0.00, "nombrePodologo": null, "tipoComprobante": "RECIBO"}
29205	neondb_owner	2026-06-24	15:48:16.479815	INSERT	DetalleVenta	127.0.0.1	\N	{"id": 98, "idVenta": 51, "cantidad": 2, "subtotal": 40.00, "createdAt": "2026-06-24T15:48:16.497", "updatedAt": "2026-06-24T15:48:16.497", "idProducto": 99, "tipoUnidad": "BLISTER", "descuentoLinea": 0.00, "precioUnitario": 20.00}
29206	neondb_owner	2026-06-24	15:48:16.479815	UPDATE	Producto	127.0.0.1	{"id": 99, "activo": true, "nombre": "metamizol", "createdAt": "2026-06-24T06:15:47.068", "updatedAt": "2026-06-24T06:34:00.422", "esServicio": false, "precioCaja": 60.00, "descripcion": "Para quitar calentura", "idCategoria": 18, "laboratorio": null, "precioVenta": 2.00, "stockActual": 96, "stockMinimo": 5, "codigoBarras": "4566465454564", "esDatoPrueba": false, "precioCompra": 1.00, "unidadMedida": "unidad ", "concentracion": "500 mg", "idLaboratorio": null, "precioBlister": 20.00, "margenUtilidad": null, "unidadesPorCaja": 50, "fechaVencimiento": null, "blísteresPorCaja": null, "formaPresentacion": null, "unidadesPorBlister": 10}	{"id": 99, "activo": true, "nombre": "metamizol", "createdAt": "2026-06-24T06:15:47.068", "updatedAt": "2026-06-24T15:48:16.589", "esServicio": false, "precioCaja": 60.00, "descripcion": "Para quitar calentura", "idCategoria": 18, "laboratorio": null, "precioVenta": 2.00, "stockActual": 76, "stockMinimo": 5, "codigoBarras": "4566465454564", "esDatoPrueba": false, "precioCompra": 1.00, "unidadMedida": "unidad ", "concentracion": "500 mg", "idLaboratorio": null, "precioBlister": 20.00, "margenUtilidad": null, "unidadesPorCaja": 50, "fechaVencimiento": null, "blísteresPorCaja": null, "formaPresentacion": null, "unidadesPorBlister": 10}
...
40	LOGIN_EXITOSO	Usuario	9	{"correo":"kevingabrield23@gmail.com","rol":"ADMIN"}	9	2026-06-24 15:45:14.877	FARMACIA
41	ACTUALIZAR_PACIENTE	Cliente	49	{"nombre":"Justin Ramsess Flores Camacho"}	9	2026-06-24 15:46:10.339	CLINICA
42	ACTUALIZAR_PACIENTE	Cliente	49	{"nombre":"Justin Ramsess Flores Camacho"}	9	2026-06-24 15:47:49.219	CLINICA
43	CREAR_VENTA	Venta	51	{"total":40,"metodoPago":"EFECTIVO","idCliente":null,"tipoComprobante":"RECIBO","estado":"COMPLETADA","montoRecibido":500,"cambio":460,"rucCliente":null,"items":1,"productos":[{"idProducto":99,"cantidad":2,"tipoUnidad":"BLISTER"}],"lotesDeducidos":[{"idProducto":99,"lote":"225478S","cantidad":20}]}	9	2026-06-24 15:48:16.603	FARMACIA
\.
...
49	Justin Ramsess Flores Camacho	57921648	tututu@gmail.com	001-150898-1021R	\N	ceibo 1/2 c abajo	t	2026-06-24 04:13:27.849	2026-06-24 15:47:49.202	f	2006-06-18 00:00:00	MASCULINO	AMBOS
\.
...
1	49	\N	\N	\N	\N	2026-06-24 15:46:10.307	2026-06-24 15:47:49.207
\.
...
98	51	99	2	20.00	40.00	BLISTER	2026-06-24 15:48:16.497	2026-06-24 15:48:16.497	0.00
\.
...
80	98	101	20	2026-06-24 15:48:16.555
\.
...
--
-- Data for Name: ExamenPaciente; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public."ExamenPaciente" (id, "idPaciente", nombre, tipo, "fechaExamen", resultado, interpretacion, observaciones, "archivoUrl", "archivoNombre", "archivoTipo", "registradoPor", activo, "esDatoPrueba", "createdAt", "updatedAt", "deletedAt") FROM stdin;
\.
...
101	99	225478S	2026-10-31 00:00:00	50	30	1.00	\N	t	2026-06-24 06:15:47.214	2026-06-24 15:48:16.55
\.
...
197	99	101	SALIDA_VENTA	20	76	1.00	Venta #51	9	2026-06-24 15:48:16.569	Salida de lote: 225478S (20 unds)
\.
...
COPY public."Producto" (id, nombre, "codigoBarras", descripcion, "fechaVencimiento", "idCategoria", "precioCompra", "precioVenta", "precioBlister", "precioCaja", "unidadesPorBlister", "unidadesPorCaja", "stockActual", "stockMinimo", activo, "createdAt", "updatedAt", concentracion, "esDatoPrueba", "esServicio", laboratorio, "unidadMedida", "blísteresPorCaja", "formaPresentacion", "idLaboratorio", "margenUtilidad") FROM stdin;
98	er	88549645641894	a	\N	17	1.00	6.00	2.40	384.00	2	320	114	1	t	2026-06-24 04:21:10.516	2026-06-24 04:52:01.806	1000000 mg	f	f	prrrr	nada 	\N	\N	\N	\N
99	metamizol	4566465454564	Para quitar calentura	\N	18	1.00	2.00	20.00	60.00	10	50	76	5	t	2026-06-24 06:15:47.068	2026-06-24 15:48:16.589	500 mg	f	f	\N	unidad 	\N	\N	\N	\N
\.
...
51	2026-06-24 15:48:16.496	\N	40.00	EFECTIVO	\N	\N	9	RECIBO	COMPLETADA	500.00	460.00	\N	2026-06-24 15:48:16.497	2026-06-24 15:48:16.497	0.00	\N
\.
...
SELECT pg_catalog.setval('public."AuditoriaLog_id_seq"', 43, true);
...
SELECT pg_catalog.setval('public."Auditoria_id_seq"', 29206, true);
...
SELECT pg_catalog.setval('public."DatosClinicosPaciente_id_seq"', 2, true);
...
SELECT pg_catalog.setval('public."DetalleVentaLote_id_seq"', 80, true);
...
SELECT pg_catalog.setval('public."DetalleVenta_id_seq"', 98, true);
...
--
-- Name: ExamenPaciente_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."ExamenPaciente_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."MovimientoInventario_id_seq"', 197, true);
...
SELECT pg_catalog.setval('public."Venta_id_seq"', 51, true);
...
--
-- Name: ExamenPaciente ExamenPaciente_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ExamenPaciente"
    ADD CONSTRAINT "ExamenPaciente_pkey" PRIMARY KEY (id);
...
--
-- Name: ExamenPaciente_fechaExamen_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ExamenPaciente_fechaExamen_idx" ON public."ExamenPaciente" USING btree ("fechaExamen");


--
-- Name: ExamenPaciente_idPaciente_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ExamenPaciente_idPaciente_idx" ON public."ExamenPaciente" USING btree ("idPaciente");


--
-- Name: ExamenPaciente_tipo_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "ExamenPaciente_tipo_idx" ON public."ExamenPaciente" USING btree (tipo);
...
--
-- Name: ExamenPaciente ExamenPaciente_idPaciente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ExamenPaciente"
    ADD CONSTRAINT "ExamenPaciente_idPaciente_fkey" FOREIGN KEY ("idPaciente") REFERENCES public."Cliente"(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: ExamenPaciente ExamenPaciente_registradoPor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."ExamenPaciente"
    ADD CONSTRAINT "ExamenPaciente_registradoPor_fkey" FOREIGN KEY ("registradoPor") REFERENCES public."Usuario"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
\unrestrict HriNvApNlnZZXksSJcMAfeiHXIrhd9h6ShsCaxQ0fTu59MANWUlL1NoHYzEh4Af
